...
import com.example.maxim_ozarovskiy.medievalknight.presenters.fragment.WeaponAndShieldMarketplaceFragmentPresenter;
...
public class WeaponAndShieldFragment extends Fragment implements WeaponAndShieldFragmentContract.View, ArmorItemsAdapter.EquipItemClickListener<ArmorItems> {

    private WeaponAndShieldMarketplaceFragmentPresenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initUI(v);
        presenter = new WeaponAndShieldMarketplaceFragmentPresenter(getActivity(),this);
        presenter.callItemsFromArmory(SWORD,SHIELD);
        return v;
