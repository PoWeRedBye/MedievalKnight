...
import com.example.maxim_ozarovskiy.medievalknight.presenters.fragment.BootsMarketplaceFragmentPresenter;

import java.util.List;

import static com.example.maxim_ozarovskiy.medievalknight.activity.SplashActivity.BOOTS;

public class BootsMarketplaceItemsFragment extends Fragment implements BootsFragmentContract.View, ArmorItemsAdapter.EquipItemClickListener<ArmorItems> {

    private BootsMarketplaceFragmentPresenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initUI(v);
        presenter = new BootsMarketplaceFragmentPresenter(getActivity(),this);
        presenter.callItemsFromArmory(BOOTS);
        return v;
